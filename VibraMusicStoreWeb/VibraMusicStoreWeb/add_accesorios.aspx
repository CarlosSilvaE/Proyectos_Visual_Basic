<%@ Page Title="Agregar Accesorios" Language="VB" MasterPageFile="~/master.master" AutoEventWireup="true" CodeBehind="add_accesorios.aspx.vb" Inherits="VibraMusicStoreWeb.add_accesorios" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="instrumentos-container">
        ...
        <div class="main-panel">
            <!-- GridView de accesorios -->
            <div class="grid-container">
                <asp:GridView ID="gvAccesorios" runat="server" AutoGenerateColumns="False" CssClass="gridView">
                    <Columns>
